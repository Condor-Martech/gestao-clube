    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 32, fontWeight: 700, marginTop: 8 }}>
          ...
          <span style={{ color: '#64748b', fontWeight: 400 }}>{log.id.slice(8)}</span>
        </div>
        <div
          style={{
            display: 'flex',
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ color: '#64748b', fontSize: 11, letterSpacing: 1 }}>OCORRIDO EM</span>
            <span style={{ fontFamily: 'ui-monospace, monospace' }}>{fmtDate(log.created_at)}</span>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ color: '#64748b', fontSize: 11, letterSpacing: 1 }}>CAPTURADO EM</span>
            <span style={{ fontFamily: 'ui-monospace, monospace' }}>{fmtDate(capturedAt)}</span>
          </div>
        </div>
      </div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <span style={{ color: '#64748b', fontSize: 11, letterSpacing: 1 }}>MÓDULO</span>
          <span style={{ fontWeight: 600, color: '#0f172a' }}>{log.module ?? '—'}</span>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <span style={{ color: '#64748b', fontSize: 11, letterSpacing: 1 }}>EVENTO</span>
          <span
            style={{
              fontFamily: 'ui-monospace, monospace',
              color: '#0f172a',
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <span style={{ color: '#64748b', fontSize: 11, letterSpacing: 1 }}>USUÁRIO</span>
          <span
            style={{
              fontFamily: 'ui-monospace, monospace',
              color: '#0f172a',
      ...
      >
        ...
        >
          verifique: sha256(JSON.stringify(payload)) do log id={log.id} na view logs_with_users
        </div>
      </div>
    </div>,
    {
