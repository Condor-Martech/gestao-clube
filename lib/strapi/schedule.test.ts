...
describe('utcIsoToBrtLocal', () => {
  it('shifts UTC to BRT wall-clock by -3h', () => {
    expect(utcIsoToBrtLocal('2027-02-28T03:00:00.000Z')).toBe(
      '2027-02-28T00:00',
    )
  })

  it('handles end-of-day rollover into the previous BRT day', () => {
    expect(utcIsoToBrtLocal('2026-04-01T02:59:00.000Z')).toBe(
      '2026-03-31T23:59',
    )
  })
